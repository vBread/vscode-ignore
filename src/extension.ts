import { commands, languages, window, workspace, type DocumentSelector, type ExtensionContext } from "vscode";
	...
	context.subscriptions.push(
		...
		window.onDidChangeActiveTextEditor(e => {
			if (
				...
				&& e
				&& e.document.fileName.endsWith('.gitignore') && /^\s*$/.test(e.document.getText())
			) {
